    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filtered = data.filter((item) => 
          item.tenSanPham.toLowerCase().includes(q.toLowerCase()) && item.trangThai === "con_hang"
        );
  ...
  return (
    <div className="category-page">
      ...
      <div className="category-page-header">
        ...
        <p>Hiển thị kết quả cho từ khóa: <b>{q}</b></p>
      </div>
      ...
      <div className="products-4col">
        {loading ? (
          ...
          <p>Không tìm thấy sản phẩm nào phù hợp với "{q}".</p>
        ) : (
...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="category-page"><div className="category-page-header"><p>Đang tải...</p></div></div>}>
      <SearchResults />
    </Suspense>
  );
}
