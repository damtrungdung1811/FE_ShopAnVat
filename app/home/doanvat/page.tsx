...
export default function DoAnVatPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filtered = data.filter((item: Product) => item.danhMucId === 1 && item.trangThai === "con_hang");
        setProducts(filtered);
      } catch (error) {
        console.error("Lỗi lấy sản phẩm đồ ăn vặt:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="category-page">
      ...
      <div className="category-page-header">
        <h1>🍟 Đồ Ăn Vặt</h1>
        <p>Khám phá các món ăn vặt ngon nhất Hà Nội với giá siêu hấp dẫn</p>
      </div>
      ...
      <div className="products-4col">
        {loading ? (
          ...
          <p>Chưa có sản phẩm đồ ăn vặt.</p>
        ) : (
